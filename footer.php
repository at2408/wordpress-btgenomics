  ...
  <footer>
      <div style="background: #24365E;">
        <div class="content-container pt-0">
          <div class="row" style="justify-content: space-between; padding-top: 30px; padding-bottom: 30px;">
            <div class="col-lg-4 col-6 fix-margin">
              <img src="<?php bloginfo('template_directory');?>/image/BTG_logo_white.png" class="img-fluid">
            </div>
            <div class="col-lg-2 col-4 fix-margin">
              <img src="<?php bloginfo('template_directory');?>/image/live_chat_con.png" class="img-fluid">
            </div>
          </div>
          <div class="row" style="color: #fff;">
            <div class="col-lg-3 col-10 fix-margin">
              <div style="margin-bottom: 20px; font-weight: bold; color: #2CACE3;">Contact us</div>
            ...
            <div class="col-lg-2 col-10 fix-margin">
              <div style="margin-bottom: 20px; font-weight: bold; color: #2CACE3;">Subscribe</div>
              <div style="font-size: 16px;">
                <div>
                  Sign up for BTGenomics newsletter and get lattest news & updates
                </div>&nbsp;
                <div>
                  <input type="email" placeholder="enter e-mail" style="outline: none; width: 100%; text-align: center; padding: 10px;">&nbsp;
                  <button type="button" class="btn" style="width: 100%; border-radius: inherit; background: #C64C9C; color: #fff;">Subscribe</button>
                </div>
              </div>
            </div>
            <div class="col-lg-2 col-10 fix-margin">
              <div style="margin-bottom: 20px; font-weight: bold; color: #2CACE3;">Social networks</div>
              <div style="font-size: 16px;">
                <div style="display: flex;">
